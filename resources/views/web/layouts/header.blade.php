                ...
                <li class="nav-item dropdown ">
                    <a href="javascript:void(0);" class="nav-link d-flex align-items-center gap-2"
                        ...
                        <div class="profile-image">
                            <img src="./assets/images/user-profile.png" style="width: 50px; height: 50px;"
                            ...
                            <div class="p-0 card-body">
                                <a href="javascript:void(0);" class="iq-sub-card">
                                    <div class="d-flex align-items-center p-3 border-bottom">
                                        <div
                                            class="gt-bg-theme hw-50px d-flex align-items-center justify-content-center  px-3 py-2 rounded-pill">
