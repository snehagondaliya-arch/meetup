                ...
                <div class="d-flex flex-column justify-content-between gap-3 h-100">
                    <div>
                        <div class="gt-bg-s2 rounded-12 p-2 d-flex justify-content-between gap-2 mb-3">
                            <p class="mb-0 d-flex align-items-center fw-500 fs-14px text-muted line-clamp-1"><i
                                    class="fa-regular fa-user me-1"></i>Hosted By: <span
                                    class="gt-text-title ms-1">{{ $event->host_name }}</span></p>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="d-flex justify-content-evenly">
                            ...
                            <!-- Edit Button -->
                            <a href="{{ route('events.edit', $event->slug) }}" class="btn btn-outline-success py-2">
